<?php
	...
	require_once('../models/Teachers.class.php');
	...
	function formatResult($obj){
		...
		$item = array();
		$institution = new Institution($obj->getInstitutionId());
        ...
        $item['institutionId']   = $obj->getInstitutionId();
        $item['institutionName'] = $institution->getFullname();
		return $item;
	}
