...
<div id="student" class="page-content">
		<h3>Alunos</h3>						
		<div class="row">
			<div class="col-md-12">
				<div id="student-filter" class="card card-default content-header">	
					<div class="card-header">
						<div class="row">
							...
							<div class="form-group col-md-4" style="text-align:right">								
								<button id="newStudentBtn" onclick="openPopEditStudent('')" class="btn btn-primary">Cadastrar Novo</button>
							</div>
							<?php endif; ?>
						</div>
					</div>
		...
		<div id="data-wrapper" class="scroll-pane">
			<div id="data-holder" class="table-responsive">
				<table id="student-data-table" class="table table-striped table-bordered tablesorter">
	...
	<?php include_once(_ABSOLUTEPATH.'/views/html/students/popInfoStudent.php');?>	
	<?php include_once(_ABSOLUTEPATH.'/views/html/students/popEditStudent.php');?>
</div>
<script src="<?=_FULLPATH?>/views/js/students.js"></script>
