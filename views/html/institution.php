...
<div id="institution" class="page-content">		
		<h3>Escolas</h3>					
		<div class="row">
			<div class="col-md-12">
				<div id="institution-filter" class="card card-default content-header">	
					<div class="card-header">
						<div class="row">
							...
							<div class="form-group col-md-4" style="text-align:right">								
								<button id="newInstitutionBtn" onclick="openPopEditInstitution('')" class="btn btn-primary">Cadastrar Novo</button>
							</div>
							<?php endif; ?>
						</div>
					</div>
		...
		<div id="data-wrapper" class="scroll-pane">
			<div id="data-holder" class="table-responsive">
				<table id="institution-data-table" class="table table-striped table-bordered tablesorter">
	...
	<?php include_once(_ABSOLUTEPATH.'/views/html/institution/popInfoInstitution.php');?>	
	<?php include_once(_ABSOLUTEPATH.'/views/html/institution/popEditInstitution.php');?>
</div>
<script src="<?=_FULLPATH?>/views/js/institution.js"></script>
